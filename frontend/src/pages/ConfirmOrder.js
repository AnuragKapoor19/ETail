    ...
    return (
        <>
            ...
            <div className='bg-container'>
                ...
                <div className='order-container col-12 d-flex p-4 flex-wrap my-5 justify-content-center text-light'>
                    <div className="f-container div-1 col-sm-12 col-md-7 col-lg-7 m-4 p-3">
                        ...
                        <div className="cartItems">
                            ...
                            <div style={{ overflowY: 'auto', maxHeight: '22vh' }}>
                                {cartItems.map((item) => (
                    ...
                    <div className='f-container div-2 order-summary col-sm-12 col-md-4 col-lg-4 p-4 d-flex flex-column justify-content-center m-4'>
                        <h3>Order Summary</h3>
                        <hr />
                        ...
                        <div className='btn btn-warning rounded-5 w-100 fw-bolder' onClick={handleProceed}>Proceed to Payment</div>
                    </div>
                </div>
            </div>
        </>
